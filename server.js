...
app.get('/api/camps', (req, res) => {
    ...
    db.query("SHOW TABLES LIKE 'donationcamp'", (err, tables) => {
        ...
        function fetchCamps() {
            ...
            db.query("SHOW COLUMNS FROM donationcamp LIKE 'Status'", (err, statusColumns) => {
                if (err) {
                ...
                if (statusColumns.length === 0) {
                    ...
                    db.query("ALTER TABLE donationcamp ADD COLUMN Status VARCHAR(20) DEFAULT 'Upcoming' AFTER Description", (alterErr) => {
                        if (alterErr) {
                ...
                db.query(query, (err, results) => {
                    if (err) {
                        ...
                        db.query(safeQuery, (safeErr, safeResults) => {
                            ...
                            const camps = safeResults.map(camp => ({
                                ...camp,
